	...
	function simpan_galeri(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$client=strip_tags($this->input->post('xclient'));
							$url=strip_tags($this->input->post('xurl'));
							$deskripsi=strip_tags($this->input->post('xdesc'));
							...
							$this->m_galeri->simpan_galeri($judul,$album,$user_id,$user_nama,$gambar,$client,$url,$deskripsi,$slug);

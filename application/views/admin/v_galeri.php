            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                       ...
                       $client=$i['galeri_nama_client'];
                       $url=$i['galeri_url_web'];
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Client</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xclient" class="form-control" id="inputClient" placeholder="Client" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xurl" class="form-control" id="inputUrl" placeholder="Url" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xdesc" class="form-control" id="inputDeskripsi" placeholder="Deskripsi" required>
                                        </div>
                                    </div>
